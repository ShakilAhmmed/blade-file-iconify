...
use ShakilAhmmed\BladeFileIconify\Console\SaveIconsCommand;
use ShakilAhmmed\BladeFileIconify\Components\Icon;
...
final class BladeFileIconifyServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->commands([SaveIconsCommand::class]);
    }
    ...
    private function bootPublishing(): void
    {
        if ($this->app->runningInConsole()) {
            ...
            $this->publishes([
                __DIR__ . '/../resources/svg' => resource_path('blade-file-iconify/svg'),
            ], 'blade-file-iconify');
